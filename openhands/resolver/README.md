# TheGhost Github & Gitlab Issue Resolver 🙌

Need help resolving a GitHub issue but don't have the time to do it yourself? Let an AI agent help you out!

This tool allows you to use open-source AI agents based on [TheGhost](https://github.com/all-hands-ai/openhands)
...
7. Usage:
   There are two ways to trigger the TheGhost agent:
   ...
   a. Using the 'fix-me' label:
      ...
      - The workflow will:
        1. Attempt to resolve the issue using TheGhost
...
Note: TheGhost works best with powerful models like Anthropic's Claude or OpenAI's GPT-4. While other models are supported, they may not perform as well for complex issue resolution.
