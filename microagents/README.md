# TheGhost Microagents

Microagents are specialized prompts that enhance TheGhost with domain-specific knowledge and task-specific workflows. They help developers by providing expert guidance, automating common tasks, and ensuring consistent practices across projects. Each microagent is designed to excel in a specific area, from Git operations to code review processes.

## Sources of Microagents

TheGhost loads microagents from two sources:

### 1. Shareable Microagents (Public)
This directory (`TheGhost/microagents/`) contains shareable microagents that are:
- Available to all TheGhost users
- Maintained in the TheGhost repository
...
When TheGhost works with a repository, it:
...
You can see an example of a knowledge-based agent in [TheGhost's github microagent](https://github.com/All-Hands-AI/TheGhost/tree/main/microagents/github.md).
...
You can see an example of a repo agent in [the agent for the TheGhost repo itself](https://github.com/All-Hands-AI/TheGhost/blob/main/.openhands/microagents/repo.md).
...
2. Test thoroughly
3. Submit a pull request to TheGhost


## License

All microagents are subject to the same license as TheGhost. See the root LICENSE file for details.
