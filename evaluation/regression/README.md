# TheGhost - Regression Test Framework

TheGhost project is an open-source software engineering AI that can solve various software engineering tasks. This repository contains the regression test framework for TheGhost project.

## Running the Tests

To run the tests for TheGhost project, you can use the provided test runner script. Follow these steps:
...
The test cases for TheGhost project are organized in the `cases/` directory. Each test case has the following structure:
...
- `outputs/`: This directory contains the output generated by TheGhost for each agent.
- `outputs/*/workspace/`: This directory contains the actual output files generated by TheGhost.
- `test_*.py`: These are the test scripts that validate the output of TheGhost.
...
- `run_test_case`: A fixture that runs TheGhost and generates the workspace for the current test case.
