# Commit0 Evaluation with TheGhost
...
## TheGhost Commit0 Instance-level Docker Support

TheGhost supports using the Commit0 Docker for **[inference](#run-inference-on-commit0-instances).
