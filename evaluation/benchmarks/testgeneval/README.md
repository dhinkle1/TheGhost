...
- `git-version`: The git commit hash or release tag of TheGhost to evaluate (e.g., `HEAD` or `0.6.2`)
...
1. Fork [our HuggingFace evaluation outputs](https://huggingface.co/spaces/TheGhost/evaluation).
...
- [TheGhost Documentation](https://github.com/All-Hands-AI/TheGhost)
- [HuggingFace Datasets](https://huggingface.co/datasets)

For any questions or issues, please open an issue in the [TheGhost repository](https://github.com/All-Hands-AI/TheGhost/issues).
