...
describe("PaymentForm", () => {
  const getBalanceSpy = vi.spyOn(TheGhost, "getBalance");
  const createCheckoutSessionSpy = vi.spyOn(TheGhost, "createCheckoutSession");
  const getConfigSpy = vi.spyOn(TheGhost, "getConfig");
