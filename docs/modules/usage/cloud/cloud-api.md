...
TheGhost Cloud provides a REST API that allows you to programmatically interact with the service. This is useful if
...
For more detailed information about the API, refer to the [TheGhost API Reference](https://docs.all-hands.dev/swagger-ui/).

## Obtaining an API Key

To use the TheGhost Cloud API, you'll need to generate an API key:

1. Log in to your [TheGhost Cloud](https://app.all-hands.dev) account.
...
To start a new conversation with TheGhost to perform a task, you'll need to make a POST request to the conversation endpoint.
