...
1. TheGhost achemine l'appel vers le serveur MCP approprié
2. Le serveur traite la demande et renvoie une réponse
3. TheGhost convertit la réponse en une observation et la présente à l'agent
