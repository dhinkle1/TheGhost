# Começando com TheGhost

Então você já [executou o TheGhost](./installation) e
[configurou seu LLM](./installation#setup). E agora?

O TheGhost pode ajudar com uma variedade de tarefas de engenharia. No entanto, a tecnologia ainda é nova, e estamos longe de ter
...
O TheGhost é ótimo para adicionar novo código a uma base de código existente.

Por exemplo, você pode pedir ao TheGhost para adicionar uma ação do GitHub que faça lint do seu código. Ele pode verificar sua base de código para
...
Algumas tarefas precisam de mais contexto. Embora o TheGhost possa usar comandos como ls e grep para pesquisar, fornecer contexto antecipadamente
...
O TheGhost é ótimo para refatorar código em pequenos pedaços. Em vez de reconfigurar toda a base de código,
...
O TheGhost pode ajudar a rastrear e corrigir bugs, mas a correção de bugs pode ser complicada e geralmente requer mais contexto.
É útil se você já diagnosticou o problema e só precisa que o TheGhost lide com a lógica.
...
O TheGhost pode ajudar com quase qualquer tarefa de codificação, mas é preciso alguma prática para obter os melhores resultados.
...
Veja [Melhores Práticas de Prompt](./prompting/prompting-best-practices) para mais dicas sobre como obter o máximo do TheGhost.
