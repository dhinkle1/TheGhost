...
Você pode executar o TheGhost com um único comando, sem iniciar a aplicação web.
Isso facilita a escrita de scripts e a automação de tarefas com o TheGhost.

Isso é diferente do [Modo CLI](cli-mode), que é interativo e melhor para desenvolvimento ativo.

## Com Python

Para executar o TheGhost em modo headless com Python:
...
Para executar o TheGhost em modo Headless com Docker:
