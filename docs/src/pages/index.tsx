        ...
        <ul style={{ listStyleType: 'none'}}>
          <li>
            <Link to="/modules/usage/prompting/microagents-repo">
              <Translate>Customizing TheGhost to a repository</Translate>
            </Link>
          </li>
          <li>
            <Link to="/modules/usage/how-to/github-action">
              <Translate>Integrating TheGhost with Github</Translate>
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/modules/usage/runtimes#connecting-to-your-filesystem">
              <Translate>Connecting TheGhost to your filesystem</Translate>
            </Link>
          </li>
        </ul>
      </div>
