...
help:
	...
	@echo "  $(GREEN)setup-config$(RESET)        - Setup the configuration for TheGhost by providing LLM API key,"
	@echo "                        LLM Model name, and workspace directory."
	@echo "  $(GREEN)start-backend$(RESET)       - Start the backend server for the TheGhost project."
	@echo "  $(GREEN)start-frontend$(RESET)      - Start the frontend server for the TheGhost project."
	@echo "  $(GREEN)run$(RESET)                 - Run the TheGhost application, starting both backend and frontend servers."
	@echo "                        Backend Log file will be stored in the 'logs' directory."
	@echo "  $(GREEN)docker-dev$(RESET)          - Build and run the TheGhost application in Docker."
	@echo "  $(GREEN)docker-run$(RESET)          - Run the TheGhost application, starting both backend and frontend servers in Docker."
